...
if (from) {
  ...
  const files = ['lib/optimizationHarness.ts', 'lib/numericRewriteFallback.ts', 'lib/sourceTaskRewrite.ts', 'lib/harnessTrace.ts', 'lib/contentQuality.ts', 'lib/bulletAtsGain.ts', 'lib/atsScore.ts', 'lib/atsGuard.ts', 'lib/keywordAliases.ts', 'lib/optimizeChunks.ts', 'lib/optimizeContract.ts', 'lib/resumeStructure.ts', 'lib/semanticGrounding.ts', 'lib/resumeImpact.ts', 'scripts/eval-uplift.mjs', 'scripts/lib/uplift-evaluation.mjs'];
